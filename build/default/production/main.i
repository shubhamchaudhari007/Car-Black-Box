...
void view_dashboard(void) {
    ...
    clcd_print("SP", (0x80 + (13)));


    clcd_print(time_buf, (0xC0 + (0)));
    clcd_print(gear[gear_index], (0xC0 + (10)));
    clcd_print(speed1, (0xC0 + (13)));





    if (key == 1 && gear_index < 7) gear_index++;
    if (key == 2 && gear_index > 0) gear_index--;
    if (key == 3) gear_index = 8;
...
void display_main_menu(void) {
    ...
    if (menu_index == 0) {
        ...
        clcd_putch(' ', (0x80 + (0)));
        clcd_print(menu[menu_index - 1], (0x80 + (2)));
        clcd_putch('*', (0xC0 + (0)));
        clcd_print(menu[menu_index], (0xC0 + (2)));
    }
...
void view_log(void) {
    ...
    clcd_print(read_data[log_index], (0xC0 + (0)));
}
...
void clear_log(void) {
    ...
    clcd_print("Cleared data", (0x80 + (0)));
...
void download_log(void) {
    ...
    clcd_print("downloading data", (0x80 + (0)));
...
void blink_field(unsigned short f) {
    ...
    if (field == 0) {
        if (count++ < 500) {
            ...
            count = 0;
        clcd_putch(':', (0xC0 + (2)));
        clcd_putch(min_val / 10 + '0', (0xC0 + (3)));
        clcd_putch(min_val % 10 + '0', (0xC0 + (4)));
        clcd_putch(':', (0xC0 + (5)));
        clcd_putch(sec_val / 10 + '0', (0xC0 + (6)));
        clcd_putch(sec_val % 10 + '0', (0xC0 + (7)));
    } else if (field == 1) {
        if (count++ < 500) {
            clcd_putch(min_val / 10 + '0', (0xC0 + (3)));
            clcd_putch(min_val % 10 + '0', (0xC0 + (4)));
...
void set_time(void) {
    ...
    if (key == 11) {
        ...
        write_ds1307(0x02, hour_reg);
        write_ds1307(0x01, (unsigned char) (((min_val / 10) << 4) | (min_val % 10)));
        write_ds1307(0x00, (unsigned char) (((sec_val / 10) << 4) | (sec_val % 10)));
